...
- [ ] One remediation chosen and applied:
...
- [ ] dnsmasq shows exactly one MAC identity for 10.11.1.23; `ip neigh` for 10.11.1.23 matches the registered MAC.
- [ ] `host_vars/srv-nas` gains a real `pxe24` entry reflecting the chosen MAC (drift note removed).
